...
# .devcontainer/install-matterbridge-main.sh v.1.1.0
...
echo "1 - Installing Matterbridge from the main branch..."
cd /
...
echo "3 - Cloning Matterbridge from the main branch..."
...
echo "8 - Matterbridge has been installed from the main branch."
